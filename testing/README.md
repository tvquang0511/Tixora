# 🧪 MODULE KIỂM THỬ HỆ THỐNG TICKETBOX (TESTING SUITE)

Module này đóng gói toàn bộ công cụ, kịch bản kiểm thử tự động End-to-End (E2E Playwright) và kiểm thử chịu tải (k6 Load Testing) của hệ thống TicketBox.
